...
const Overview: NextPage<Props> = ({
  ...
  return (
    <ApiLayout
      ...
      category={category}>
      <div className="md:grid-cols-3 md:grid py-6 md:gap-4 font-light">
        <div className=" card col-span-2 mb-6 p-4 md:p-6">
          <div className="pb-6 dark:border-zinc-800 border-b mb-6">
